...
def load_view(gui, game_methods: GameMethods):
    ...
    gui.add_gui_element(TextBlock("Reason for loss: " + game_methods.reason_for_latest_death, 300, 90))

    retry_button = Button("Retry Level", 300, 200,
                          lambda: game_methods.load_level_by_index(game_methods.get_previous_level_index()))
    retry_button.resize_button(200, 50)

    main_menu_button = Button("Main Menu", 300, 300,
